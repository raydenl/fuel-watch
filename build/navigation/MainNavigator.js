...
StationsStack.navigationOptions = {
    ...
    tabBarIcon: (focused) => (React.createElement(TabBarIcon, { focused: focused, name: Platform.OS === 'ios' ? `ios-link${focused ? '' : '-outline'}` : 'md-link' })),
};
...
SettingsStack.navigationOptions = {
    ...
    tabBarIcon: (focused) => (React.createElement(TabBarIcon, { focused: focused, name: Platform.OS === 'ios' ? `ios-options${focused ? '' : '-outline'}` : 'md-options' })),
};
